...
public class AprioriUtils {
	...
	/*
	 * Determines if an item with the specified frequency has minimum support or
	 * not.
	 */
	public static boolean hasMinSupport(int minSupport, int maxNumTxns, int itemCount) {
	...
	/*
	 * Generates the candidateItemSets of pass K from large itemsets of pass
	 * K-1.
	 */
	...
	/*
	 * Generates a map of hashcode and the corresponding itemset. Since multiple
	 * entries can have the same hashcode, there would be a list of itemsets for
	 * any hashcode.
	 */
